...
export function switchCustomPaletteStep(this: ThemeSwitcherElement) {
...
export function enableCreateColorPaletteMode(this: ThemeSwitcherElement) {
...
function getUserShades(this: ThemeSwitcherElement, selector: string): string[] {
  let shades: string[] = [];
  this.shadowRoot
...
export function handleCustomPaletteForm(this: ThemeSwitcherElement, e: Event) {
  e.preventDefault();
...
export function handleSelectColorPalette(this: ThemeSwitcherElement, e: Event) {
...
export function selectSystemColor(this: ThemeSwitcherElement) {
