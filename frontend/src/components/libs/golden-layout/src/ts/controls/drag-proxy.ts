import { DRAG_DROP_EVENT, DragDropEventType } from '../../../../../../lib/model/site';
...
export class DragProxy extends EventEmitter {
    ...
    private onDrop(): void {
        // @ts-ignore
        document.dispatchEvent(new CustomEvent<DragDropEventType>(DRAG_DROP_EVENT, { detail: this._componentItem._container._element, bubbles: true, composed: true }));
