...
export class RowOrColumn extends ContentItem {
    ...
    private createSplitter(index: number): Splitter {
        ...
        splitter.on('dragStart', () => {
            ...
            this.onSplitterDragStart(splitter)
        })
        
        // splitter.on('click', () => {
            // document.addEventListener('pointermove', this.onSplitterDragStart);
    ...
    private onSplitterDragStop(splitter: Splitter) {
        console.log("onSplitterDragStop");
